...
from datasets import Audio, DatasetDict, IterableDatasetDict, interleave_datasets, load_dataset, load_from_disk
...
def load_model_hook(models, input_dir):
    while len(models) > 0:
        ...
        AutoModel.from_pretrained(model.base_model.model, input_dir, is_trainable=True)
